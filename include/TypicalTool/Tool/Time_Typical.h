...
namespace Typical_Tool {
	...
	enum TYPICALTOOL_API TimeMeasure
	{
		ns,		// 纳秒
		us,		// 微秒
		ms,		// 毫秒
	...
	TYPICALTOOL_API Tstr TimeMeasureToString(TimeMeasure _Tm) {
		switch (_Tm) {
		case TimeMeasure::ns: {
			return TEXT("ns");
		}
	...
	TYPICALTOOL_API Tstr TimeMeasureToString() {
...
#define TimeToStr TimeMeasureToString
	...
	enum class TYPICALTOOL_API TimePointLocation {
		First = 0,	// 首 节点
		Front = 1,	// 前 节点
		Back = 2,	// 后 节点
		End = 2		// 尾 节点
